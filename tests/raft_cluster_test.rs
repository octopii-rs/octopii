...
fn test_three_node_cluster_basic() {
    ...
    let config1 = Config {
        ...
        wal_dir: std::path::PathBuf::from("_octopii_wal_files/node1"),
        worker_threads: 2,
        wal_batch_size: 10,
    ...
    let config2 = Config {
        ...
        wal_dir: std::path::PathBuf::from("_octopii_wal_files/node2"),
        worker_threads: 2,
        wal_batch_size: 10,
        wal_flush_interval_ms: 100,
    ...
    let config3 = Config {
        ...
        wal_dir: std::path::PathBuf::from("_octopii_wal_files/node3"),
        worker_threads: 2,
        wal_batch_size: 10,
        wal_flush_interval_ms: 100,
        is_initial_leader: false,
